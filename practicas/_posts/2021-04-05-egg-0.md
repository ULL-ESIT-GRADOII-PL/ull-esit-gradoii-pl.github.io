...
rubrica:
  ...
  - 
    ...
    - Comentarios
    - Localización
  - Librerías separadas para el Parser y el Intérprete
  - Interfaz (exports) del Parser y del Intérprete
  - 
    - Ejecutables
  ...
  - Se ha publicado en GitHub Registry y la publicación cumple los estándares de publicación de un módulo (CI, versionado, documentación, etc.)
  - 
    - El bucle REPL 
...
e interpretarlo.
Las siguientes prácticas irán ampliando el lenguaje con nuevas capacidades: 
...
2. Introducción al [Análisis Sintáctico Predictivo Recursivo]({{site.baseurl}}/assets/temas/syntax-analysis/analisis-descendente-predictivo-recursivo/pdr-teoria)
...
* [Ejercicio]({{site.baseurl}}/assets/temas/syntax-analysis/analisis-descendente-predictivo-recursivo/ejercicio-gramar-egg-inicial)

Escriba en su `README.md` las reglas de producción de la gramática que reconoce el traductor

Tiene una posible solución [aquí]({{site.baseurl}}/assets/temas/syntax-analysis/analisis-descendente-predictivo-recursivo//solucion-ejercicio-gramar-egg-inicial)

¿Es correcto este diseño de la gramática? 

* [Gramática modificada]({{site.baseurl}}/assets/temas/syntax-analysis/analisis-descendente-predictivo-recursivo//egg-grammar)
...
[Árboles de Análisis Abstracto]({{site.baseurl}}/assets/temas/syntax-analysis/analisis-descendente-predictivo-recursivo//ast-description)
...
A continuación mejore el analizador léxico que encuentra en la rama `master` de [ULL-ESIT-PL-1617/egg](https://github.com/ULL-ESIT-PL-1617/egg) 
como sigue:
...
{% include video provider="youtube" id="5gIlt6r29lw" %}
