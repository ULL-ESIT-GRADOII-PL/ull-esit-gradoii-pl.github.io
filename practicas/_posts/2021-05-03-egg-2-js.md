...
Puede serle útil escribir una librería `translation-support.js` con funciones que den soporte a la ejecución de los programas traducidos. 
...
que queda mas simple que la anterior solución.
