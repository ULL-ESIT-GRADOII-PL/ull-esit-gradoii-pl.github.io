...
Puede serle útil escribir una librería `translation-support.js` con funciones que den soporte a la ejecución de los programas JS traducidos. 
...
esto es para que las *variables traducidas* no **colisionen** contra variables auxiliares como `tmp` que pudieramos necesitar introducir para dar soporte a la traducción.
