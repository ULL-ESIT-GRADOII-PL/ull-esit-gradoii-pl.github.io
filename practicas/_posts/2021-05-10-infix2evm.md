...
Sigue un ejemplo de análisis de un lenguaje de infijo mínimo a un  AST Eggg muy, muy  simplificado:
...
```
➜  infix2evm-adrian-emilio-padilla-rojas git:(casiano) ✗ npm run compile &&  nearley-test -s S -i 'fun (id, idtwo, idthree) do end end' -q lua.js
...
[
  {
    ...
    args: [
      ...
      { type: 'apply', operator: 'do', args: [], line: 1, col: 26 }
    ],
    line: 1,
    col: 1
  }
