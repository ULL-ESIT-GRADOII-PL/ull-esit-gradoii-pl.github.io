...
const reserved_words = { LET: 'let', FUNCTION: 'function', 
                          WHILE: 'while', IF: 'if', ELSIF: 'elsif', 
                          ELSE: 'else' };

function idOrRw(word) {
  return (word.toUpperCase() in reserved_words) ? reserved_words[word.toUpperCase()] : 'WORD';
}
