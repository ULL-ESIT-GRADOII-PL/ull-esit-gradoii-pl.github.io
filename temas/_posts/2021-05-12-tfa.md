...
cuando se encuentra un `async` la generación del árbol por el parser cambia produciéndose nuevos tipos de nodos que se implantarían en el fichero `lib/ast.js`:
