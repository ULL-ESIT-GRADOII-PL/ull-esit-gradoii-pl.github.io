...
* Una idea puede ser extender Egg o el lenguaje de Infijo con un DSL con funcionalidades para facilitar la resolución de problemas en un contexto específico que sea del interés del alumno
...
Extienda `set` de manera que permita expresiones complejas en el lado izquierdo de la asignación como `=(self.c, +(self["c"], 1))` o bien las que aparecen en este ejemplo:
...
Observe que el lado izquierdo de una asignación podría incluir una llamada a función como en este ejemplo:
